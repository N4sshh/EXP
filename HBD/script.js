...
.birthday-button:before {
  ...
  height: 240px;
  width: 240px;
  background: radial-gradient(var(--glow), rgba(0,0,0,0.7) 30%), radial-gradient(var(--glow), rgba(0,0,0,0.5) 50%);
  border-radius: 50%;
  top: 50%;
  left: 50%;
...
.birthday-button:after {
  ...
  filter: blur(15px);
  position: absolute;
  background: radial-gradient(var(--glow), rgba(0,0,0,0.7) 20%), radial-gradient(var(--glow), rgba(0,0,0,0.5));
  top: 100%;
  left: 50%;
